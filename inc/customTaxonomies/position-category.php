...
function registerPositionCategoryTaxonomy()
{
    $labels = [
        'name'                       => _x('Positions', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Position', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Positions', 'flynt'),
    ...
    register_taxonomy('position-category', ['author'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerPositionCategoryTaxonomy');
