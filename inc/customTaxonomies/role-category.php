...
function registerRoleCategoryTaxonomy()
{
    $labels = [
        'name'                       => _x('Roles', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Role', 'Taxonomy Singular Name', 'flynt'),
    ...
    register_taxonomy('role-category', ['author'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerRoleCategoryTaxonomy');
