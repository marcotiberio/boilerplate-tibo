...
add_action('acf/init', function () {
    ...
    Options::addGlobal('Typography', [
        ...
        [
            'label' => __('Heading 1 - Size (Desktop)', 'flynt'),
        ...
        [
            'label' => __('Heading 1 - Line Height', 'flynt'),
        ...
        [
            'label' => __('Heading 2 - Size (Mobile)', 'flynt'),
        ...
        [
            'label' => __('Heading 2 - Size (Desktop)', 'flynt'),
        ...
        [
            'label' => __('Heading 2 - Line Height', 'flynt'),
        ...
        [
            'label' => __('Heading 3 - Size (Mobile)', 'flynt'),
            'instructions' => __('H3 font size in rem for mobile devices.', 'flynt'),
            'name' => 'h3SizeMobile',
            'type' => 'number',
            'default_value' => 1.75,
            'min' => 1,
        ...
        [
            'label' => __('Heading 3 - Size (Desktop)', 'flynt'),
            'instructions' => __('H3 font size in rem for desktop devices.', 'flynt'),
            'name' => 'h3SizeDesktop',
            'type' => 'number',
            'default_value' => 2,
            'min' => 1,
        ...
        [
            'label' => __('Heading 3 - Line Height', 'flynt'),
            'instructions' => __('H3 line height (unitless value, e.g., 1.2).', 'flynt'),
            'name' => 'h3LineHeight',
            'type' => 'number',
            'default_value' => 1.2,
            'min' => 0.8,
        ...
        [
            'label' => __('Heading 4 - Size (Mobile)', 'flynt'),
            'instructions' => __('H4 font size in rem for mobile devices.', 'flynt'),
            'name' => 'h4SizeMobile',
            'type' => 'number',
            'default_value' => 1.75,
            'min' => 1,
        ...
        [
            'label' => __('Heading 4 - Size (Desktop)', 'flynt'),
            'instructions' => __('H4 font size in rem for desktop devices.', 'flynt'),
            'name' => 'h4SizeDesktop',
            'type' => 'number',
            'default_value' => 2,
            'min' => 1,
        ...
        [
            'label' => __('Heading 4 - Line Height', 'flynt'),
            'instructions' => __('H4 line height (unitless value, e.g., 1.2).', 'flynt'),
            'name' => 'h4LineHeight',
            'type' => 'number',
            'default_value' => 1.2,
            'min' => 0.8,
        ...
        [
            'label' => __('Body Text - Size (Mobile)', 'flynt'),
        ...
        [
            'label' => __('Body Text - Size (Desktop)', 'flynt'),
        ...
        [
            'label' => __('Body Text - Line Height', 'flynt'),
        ...
        [
            'label' => __('Body X-Small - Size', 'flynt'),
            'instructions' => __('Body X-Small text font size in rem.', 'flynt'),
            'name' => 'bodyXSmallSize',
            'type' => 'number',
            'default_value' => 0.75,
            'min' => 0.5,
        ...
        [
            'label' => __('Body X-Small - Line Height', 'flynt'),
            'instructions' => __('Body X-Small text line height (unitless value, e.g., 1.2).', 'flynt'),
            'name' => 'bodyXSmallLineHeight',
            'type' => 'number',
            'default_value' => 1.2,
            'min' => 0.8,
            'max' => 2,
        ...
        [
            'label' => __('Button - Font Size', 'flynt'),
            'instructions' => __('Button font size in rem.', 'flynt'),
            'name' => 'buttonSize',
            'type' => 'number',
            'default_value' => 1,
            'min' => 0.75,
        ...
        [
            'label' => __('Button - Line Height', 'flynt'),
            'instructions' => __('Button line height (unitless value, e.g., 1.2).', 'flynt'),
