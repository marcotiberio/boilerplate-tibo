        ...
        'sub_fields' => [
            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        'label' => __('Color Background (Content Side)', 'flynt'),
                        'instructions' => __('Optional background color for the content side of the popup. Leave empty for white.', 'flynt'),
                        'name' => 'colorBackgroundContent',
                        'type' => 'color_picker',
                        'wrapper' => [
                            'width' => 100,
                        ],
