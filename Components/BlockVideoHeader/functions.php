...
namespace Flynt\Components\BlockVideoHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockVideoHeader', function ($data) {
...
Options::addTranslatable('BlockVideoHeader', [
    [
