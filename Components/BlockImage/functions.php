    ...
    return [
        ...
        'sub_fields' => [
            ...
            [
                ...
                'instructions' => __('JPG, PNG, SVG, WEBP. Also used as the poster/fallback when a video is set. The media Caption (set on the file in the WP library) is shown on hover.', 'flynt'),
                'name' => 'image',
                'type' => 'image',
                'preview_size' => 'medium',
                'required' => 1,
